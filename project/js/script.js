...
const makeChanges = () => {
    ...
    // poster.style.cssText = 'background: url(../img/bg.jpg)';//3
...
function createMovieList(films, parent){
    ...
    movieDB.movies.forEach((film, i)=>{
        parent.innerHTML += `
        <li><a class="promo__menu-item promo__menu-item_active" href="#">${i+1}.${film}</a></li>
        `;
    });
...
// promoContent.style.cssText('background-image: url(../img/bg.jpg)');